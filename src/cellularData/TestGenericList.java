...
public class TestGenericList 
{
   ...
   private LinkedList<Country> createRandomListOfCountries(Country [] allCountries)
   {
      ...
      try 
      {
         requestedSize = Integer.parseInt(input.nextLine());
      }
      catch(NumberFormatException e)
      {
         System.out.println("Not a valid integer entry. Requested size set to 3.");
      }
      ...
      for (int i = 0; i < requestedSize; i++)
      {
         ...
         // TODO: Modify all attributes and methods of class LinkedList to hold
         //       generic data types.
   ...
   private void testSubscriptionsTotalInList(LinkedList<Country> selectedCountryList) 
   {
      ...
      System.out.println(requestedStartYear);
      int requestedEndYear = Integer.parseInt(tokens[1]);
      System.out.println(requestedEndYear);
